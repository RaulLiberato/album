                ...
                <div class="col-lg-6">
                  <div class="d-flex flex-column h-100">
                    <div
                      ...
                      <img id="imgPrev" class="w-100" heigth="340" src="{{isset ($photo->photo_url) ? url("/storage/photos/$photo->photo_url"): asset('/img/img_padrao.png')}}" style="object-fit: cover;" alt="">
                    </div>
                    <div class="form-group mt-2">
                      <div class="custom-file">
                        <input id="photo" name="photo" type="file" class="custom-file-input" onchange="loadFile(event)" accept="image/png, image/jgp, image/gif" @empty($photo) required @endempty>
                      </div>
                    </div>
                  </div>
